...
<img src="https://goo.gl/5C0Uj3" width="100%">  

#### 2. umount一下目前掛的路徑  
```  
sudo umount /Volumes/16G  
```  
<img src="https://goo.gl/QmOs4U" width="100%">  

#### 3. 建立新的資料匣，等會用來掛隨身碟用  
```
mkdir /tmp/usb16G  
```
<img src="https://goo.gl/g76QvJ" width="100%">   
...
```
<img src="https://goo.gl/wVjuyx" width="100%">  

#### 5. ok嘍，打開一下資料匣，copy檔案進去試試  
```
open .
```
<img src="https://goo.gl/XYmkLp" width="100%">  

#### 6. 最後如果不用時，記得umount一下  
```
sudo umount /private/tmp/usb16G
```   
<img src="https://goo.gl/5bzvr4" width="100%">  
